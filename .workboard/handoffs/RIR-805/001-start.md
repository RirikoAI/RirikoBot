# RIR-805 — Specify dashboard workflows, authorization and credential lifecycle
...
Read AGENTS.md, the standing protocol, current board, relevant blueprint sections, legacy inventory and assigned specialist guidance. Gemini comparison snapshot 1ba45ee3308b1bb5c7ecb4ea850c0009abb65d33. Follow dependencies serially; never activate two tickets. Assigned paths: docs/dashboard.md, docs/adr/ADR-008-web-dashboard-architecture.md, docs/adr/ADR-011-secrets-management-and-credential-security.md.
