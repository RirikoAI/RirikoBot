# RIR-807 — Reconcile every document, requirement and comparison with evidence
...
Read AGENTS.md, the standing protocol, current board, relevant blueprint sections, legacy inventory and assigned specialist guidance. Gemini comparison snapshot 1ba45ee3308b1bb5c7ecb4ea850c0009abb65d33. Follow dependencies serially; never activate two tickets. Assigned paths: docs/requirements.json, docs/requirements.md, docs/branch-comparison.md, docs/documentation-review.md.
