...
export const DEFAULT_SIM_PROFILES: readonly SimProfile[] = [
  ...
  {
    id: 'starter',
    label: 'Grinding F1-4: COMMON Lv8, blade + shop armor and charm',
    rarity: 'COMMON',
    level: 8,
    gear: [
  ...
  {
    id: 'early',
    label: 'Early climber: UNCOMMON Lv12, full shop set +2, F5 badge',
    rarity: 'UNCOMMON',
    level: 12,
    gear: [
  ...
  {
    id: 'mid',
    label: 'Mid tower: RARE Lv22, F10 staff +3, rare set from F10-19 drops',
    rarity: 'RARE',
    level: 22,
    gear: [
      { code: 'WEAPON_CRIMSON_CHANT_STAFF', enhancement: 3 },
      { code: 'ARMOR_CRUSADER_PLATE', enhancement: 3 },
  ...
  {
    id: 'late',
    label: 'Late tower: SUPER_RARE Lv35, SR set +3/+5 from F20-29',
    rarity: 'SUPER_RARE',
    level: 35,
    gear: [
      { code: 'WEAPON_SOLAR_LANCE', enhancement: 5 },
      { code: 'ARMOR_DRAGONSCALE_PLATE', enhancement: 5 },
      { code: 'RELIC_PHOENIX_ASH_CENSER', enhancement: 3 },
      { code: 'RING_SWORD_SAINT_BAND', enhancement: 3 },
      { code: 'AMULET_OBSIDIAN_HEART', enhancement: 3 },
      { code: 'TALISMAN_MANEUVER_GEAR', enhancement: 3 },
    ],
    potions: 3,
  },
  {
    id: 'endgame',
    label: 'Endgame: ULTRA_RARE Lv50, UR set +5/+8 from F30-39',
    rarity: 'ULTRA_RARE',
    level: 50,
    gear: [
      { code: 'WEAPON_CALIDOS_GAUNTLETS', enhancement: 8 },
      { code: 'ARMOR_AEGIS_BARRIER', enhancement: 8 },
      { code: 'RELIC_CHRONOS_HOURGLASS', enhancement: 5 },
      { code: 'RING_INFERNO_CROWN', enhancement: 5 },
      { code: 'AMULET_HARVEST_POUCH', enhancement: 5 },
      { code: 'TALISMAN_TEMPEST_FEATHER', enhancement: 5 },
    ],
    potions: 3,
  },
];
