...
## Engineering
[Original blueprint](BLUEPRINT.md) · [Requirement coverage and remaining gaps](docs/requirements.md) · [Pinned Astra/Gemini comparison](docs/branch-comparison.md). Coverage of the specification is tracked separately from implementation and release completion.
